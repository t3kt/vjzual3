...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 582.75, 407.0, 20.0, 22.0 ],
					"style" : "",
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 602.75, 493.0, 165.5, 22.0 ],
					"style" : "",
					"text" : "get /ctrl/noise_gen_2/Paused"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 565.75, 493.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 766.0, 20.0, 22.0 ],
					"style" : "",
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 198.5, 815.0, 187.0, 22.0 ],
					"style" : "",
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 161.5, 815.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 818.0, 784.0, 20.0, 22.0 ],
					"style" : "",
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 838.0, 870.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 801.0, 870.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 822.0, 476.0, 20.0, 22.0 ],
					"style" : "",
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 842.0, 562.0, 53.5, 22.0 ],
					"style" : "",
					"text" : "1 56"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 805.0, 562.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 766.0, 353.0, 92.5, 22.0 ],
					"style" : "",
					"text" : "midiparse"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 536.0, 719.0, 48.0, 22.0 ],
					"style" : "",
					"text" : "pack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 549.25, 642.0, 39.0, 22.0 ],
					"style" : "",
					"text" : "* 127"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 422.0, 604.0, 30.0, 22.0 ],
					"style" : "",
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 519.0, 759.0, 82.0, 22.0 ],
					"style" : "",
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 509.25, 815.0, 167.0, 119.0 ],
					"varname" : "bp.MIDI Out",
					"viewvisibility" : 1
				}
...
, 							{
								"box" : 								{
									...
									"hint" : "MIDI port",
									"id" : "obj-2",
									"items" : [ "BCR2000 port 1", ",", "BCR2000 port 2" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
,
					"patching_rect" : [ 497.5, 22.0, 133.0, 116.0 ],
					"varname" : "MIDI_in",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 367.0, 499.0, 49.0, 22.0 ],
					"style" : "",
					"text" : "zl nth 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 859.0, 136.0, 20.0, 22.0 ],
					"style" : "",
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 879.0, 222.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 842.0, 222.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 119.0, 231.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 41.0, 499.0, 257.0, 100.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 549.25, 595.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 311.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "prepend get"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 271.0, 389.0, 255.0, 22.0 ],
...
,
					"style" : "",
					"text" : "dict oscmap osc-midi-mappings.json @quiet 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 536.0, 209.0, 88.0, 22.0 ],
					"style" : "",
					"text" : "unpack sym 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 298.0, 116.0, 99.0, 22.0 ],
					"style" : "",
...
, 			{
		...
		"parameters" : 		{
			"obj-58::obj-9" : [ "PitchActivityLED", "PitchActivityLED", 0 ],
			"obj-54::obj-12::obj-2" : [ "pastebang", "pastebang", 0 ],
			"obj-58::obj-14" : [ "refresh[1]", "refresh", 0 ],
			"obj-54::obj-9" : [ "MIDI_out_LED", "MIDI_out_LED", 0 ],
			"obj-58::obj-3::obj-2" : [ "pastebang[1]", "pastebang", 0 ],
			"obj-54::obj-1" : [ "refresh", "refresh", 0 ]
		}
,
		"dependency_cache" : [ 			{
